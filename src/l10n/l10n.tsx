...
export const localizedStrings = new LocalizedStrings({
  en: {
    ...
    current_nominations: 'Current nominations',
    no_nominations: 'No nominations',
    my_nominations: 'My nominations',
    bond: 'Bond',
    unbond: 'Unbond',
  ...
  hi: {
    ...
    dashboard: 'डैशबोर्ड',
    validators: 'वैलिडेटर',
    current_nominations: 'मौजूदा नामांकन',
    no_nominations: 'कोई नामांकन नहीं',
    my_nominations: 'मेरे नामांकन',
    bond: 'बॉन्ड',
    unbond: 'अनबॉन्ड',
    increase_stake: 'स्टेक बढ़ाएँ',
    stop_staking: 'स्टेकिंग रोकें',
    withdraw: 'निकासी',
    creator: 'बनाएं',
    balance: 'संपूर्ण धन',
    total_staked: 'कुल स्टेक',
    your_stake: 'आपका स्टेक',
